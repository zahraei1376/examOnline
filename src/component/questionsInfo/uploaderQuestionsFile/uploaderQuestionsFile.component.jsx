...
import {UploadButton ,UploaderButton ,UploaderButtonSend} from './uploaderQuestionsFile.styles';
...
function UploaderQuestionsFile({handleGetFileName , handleSend , file ,}) {
